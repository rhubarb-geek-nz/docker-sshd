...
then
	curl --location --fail --silent "https://cloudflare.cdn.openbsd.org/pub/OpenBSD/7.4/i386/install74.iso" --output install.iso
	...
	xorriso -boot_image any keep \
		...
		-clone /7.4/i386/cdboot /cdboot \
		-clone /7.4/i386/bsd.rd /bsd.rd
