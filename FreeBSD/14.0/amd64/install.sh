...
IMAGE=FreeBSD-14.0-RELEASE-amd64-disc1.iso.xz
...
if test ! -f "$IMAGE"
then
	curl --location --fail --silent "https://download.freebsd.org/releases/amd64/amd64/ISO-IMAGES/14.0/$IMAGE" --output "$IMAGE"
